...
## Smokes
### A short
`setpos 721.140869 49.106953 158.277359;setang -35.946613 53.519508 0.000000`
### Scooter
...
### Coffins
`setpos 110.874565 1569.597412 196.076401;setang -45.191402 76.421059 0.000000`

`setpos 328.973114 1631.043701 186.031250;setang 308.842163 84.182739 0.000131` line up with smoke pin (**safer**)

### CT
`setpos 371.457794 1687.205566 186.093811;setang -31.400839 61.583931 -0.000001` (**Deep**)
...
### CT angle
`setpos 216.241226 1662.020264 180.076263;setang -26.796385 56.038006 0.000000`
...
### Pit
`setpos 702.293030 11.999293 152.712875;setang -52.864178 -3.034568 0.000058`
### Minipit
`setpos 726.001099 278.765167 160.093811;setang -52.758759 -11.779980 0.000058`
### Arches
...
### Arches to minipit
`setpos 295.968750 644.000122 84.093811;setang -19.959703 -8.945191 0.00000` (can go slightly back and walk tap for no gap)

### Lurk smoke appartements
...
|-------|-------------------------------|----------------------------------|----------------------------------------|---------------------|
|Smoke  |[Library for B](#library-for-b)|[A short](#a-short)               | ([CT](#ct))                            |                     |
|Molotov|                               |([A long](#a-long-fallback))      | ([Dark](#dark) or [Oranges](#oranges)) |([Ypsilon](#ypsilon))|
|Flash  |                               |                                  |                                        |                     |

### B wall
|/      | Player 1                    | Player 2                         | Player 3                             |
|-------|-----------------------------|----------------------------------|--------------------------------------|
|Smoke  |[B wall far](#b-wall-far)    |[B wall close](#b-wall-close)     |                                      |
|Molotov|[Ypsilon](#ypsilon)          |                                  | [Dark](#dark) or [Oranges](#oranges) |
|Flash  |                             |[Top of oranges](#top-of-oranges) |                                      |
|       |                             |[CT angle](#ct-angle)             |                                      |
...
|/      | Player 1                      | Player 2                         | Player 3                               | Player 4                                      |
|-------|-------------------------------|----------------------------------|----------------------------------------|------------------------------------------------------------------------------------------------|
|Smoke  |[Library to A](#library-to-a)  |[A short](#a-short)               | [Arches](#arches)                      |([Arches to minipit](#arches-to-minipit) or [Lurk smoke appartements](#lurk-smoke-appartements))|
|Molotov|                               |([A long](#a-long-fallback))      |                                        | Pit                                                                                            |
|Flash  |                               |[A long flash](#a-long-flash)     |                                        |                                                                                                |
|       |                               |[A site](#a-site)                 |                                        |                                               |
### A short
|/      | Player 1                | Player 2                                   | Player 3                                           |
|-------|-------------------------|--------------------------------------------|----------------------------------------------------|
|Smoke  | [Moto/Scooter](#Scooter)| [A long](#a-long)                          | [Lurk smoke appartements](#lurk-smoke-appartements)|
|Molotov|                         | ([A short fallback](#a-short-fallback))    | Pit |
|Flash  | [Porch](#porch)         | [A long flash](#a-long-flash)              |  |
|       |                         | [A site deep](#a-site-deep)                |  |

### A wall
|/      | Player 1                | Player 2                                   | Player 3                                           |
|-------|-------------------------|--------------------------------------------|----------------------------------------------------|
|Smoke  | [Minipit](#minipit)     | [Pit](#pit)                                | [Lurk smoke appartements](#lurk-smoke-appartements)|
|Molotov|                         | ([A short fallback](#a-short-fallback))    | Pit |
|Flash  | [Porch](#porch)         | [A long flash](#a-long-flash)              |  |
|       |                         | [A site deep](#a-site-deep)                |  |
